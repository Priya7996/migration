...
export class ReportService {
  ...
  split(report):Observable<any>{
    return this.http.get('resport_split_value?report_type='+report.report_type + '&&tenant_id=' + report.tenant_id)
  }
  ...
  cnc_jobs(tenantId):Observable<any>{
    return this.http.get('cncjobs?tenant_id=2'+tenantId)
  }
